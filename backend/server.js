...
Separately from your quality assessment, rate the presence and intensity of the following content characteristics, each on a 0–10 integer scale. These are descriptive measurements for research only — they are NOT quality factors. A high or low risk score must NOT change any of your dimension scores or your overall score. Score what is actually present in the video.
CALIBRATION — read carefully: 10 means "the MOST EXTREME this characteristic gets within normal, postable short-form social-media content (TikTok / Reels / Shorts)" — NOT explicit/pornographic/graphic-beyond-platform material, which does not appear on the platform. Anchor 10 to the strong end of what real mainstream short-form videos actually do, and score relative to that. USE THE FULL 0–10 RANGE — do NOT reserve high scores only for explicit or extreme content: when a characteristic is clearly a primary draw of an ordinary postable video, it belongs at 8–9, not in the middle. Most videos still score 0 on most of these dimensions; spread the scores — 0 when absent, high when genuinely prominent.
- sexual_suggestive — degree to which the video uses sexual or physical-attractiveness appeal as a draw. Score the FRAMING and INTENT, NOT whether a person happens to be attractive. 0 = none; attractiveness, if any, is incidental (e.g. a normally-dressed talking-head). 2–3 = mild: fitted/form-fitting clothing is present but the framing, posing, and focus do NOT emphasize the body. 5 = moderate: there is some deliberate body emphasis, but it is secondary to the actual content. 8–9 = strong: a tight or revealing outfit is deliberately centered by the framing, the posing emphasizes the body, and suggestiveness is clearly a PRIMARY draw of the video (e.g. a thirst-trap dance or a revealing try-on where the body is the main subject). This realistic high end MUST score 8–9, not 5. 10 = maximally suggestive for the platform — overtly sexualized, the body is the entire point.
- violence_shock — 0 = none. 3 = mild/implied conflict or cartoonish peril. 5 = real physical altercation or injury shown without graphic detail; intense stunts. 8–9 = strongly violent or shocking for the platform: real fights, visible injury, or genuinely shocking imagery as a primary draw. 10 = the most graphic violence/gore that still stays postable.
- hate_harassment — 0 = none. 3 = edgy/insensitive language not targeting a protected group. 5 = demeaning generalization about a group, or a pointed personal attack. 8–9 = clearly hateful or harassing content targeting a protected group or individual as a central element. 10 = the most explicit hate speech or incitement that still stays postable.
- profanity — 0 = none. 3 = occasional mild language. 5 = repeated strong profanity as normal speech. 8–9 = pervasive strong profanity central to the delivery. 10 = relentless, near-constant profanity.
- outrage_inflammatory — degree of deliberate rage-bait / provocation. 0 = neutral or positive framing. 3 = mildly provocative opinion. 5 = deliberately controversial framing or rage-bait elements. 8–9 = content clearly engineered to provoke anger or division as its primary hook. 10 = pure rage-bait, maximally inflammatory.
- dangerous_acts — risky behavior viewers might imitate. 0 = none. 3 = minor, clearly controlled risk. 5 = risky behavior viewers might copy (stunts, mild challenges). 8–9 = genuinely dangerous acts presented as entertainment, clearly imitable. 10 = life-threatening acts or challenges actively encouraging imitation.
` : "";
