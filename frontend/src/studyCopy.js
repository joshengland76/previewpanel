...
// Verbatim -- minor layout edits allowed, wording must not change.
export const METHODOLOGY_MODAL_TEXT =
  ...
  "signals our judges do — hook, emotion, pacing, clarity — plus video " +
  "length, and turns them into a single prediction. In held-out testing on " +
  "creators the model had never seen, videos it ranked in its top tier beat " +
  "the creator's typical engagement about 2 out of 3 times. It's a ranking " +
  "aid, not a crystal ball: it tells you which of your videos looks " +
  "strongest, not whether a video will go viral. See how we validated it →";
